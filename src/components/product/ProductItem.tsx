            ...
            <div className={"p-4"}>
                ...
                <div className={"flex flex-col"}>
                    ...
                    <Link
                        ...
                        className={"text-center cursor-pointer w-full bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all"}
                    >
                        GRAB IT NOW
                    </Link>
                    <div className={"text-xm text-red-500 text-center mt-1 animate-pulse"}>
                        Limited time offer!
                    </div>
                </div>
            </div>
