...
const HeaderCategorySelector = async () => {
    ...
    return (
        <div className={"relative inline-block"}>
            ...
            <div className={"absolute top-full left-0 pt-2 opacity-0 invisible peer-hover:opacity-100 peer-hover:visible hover:opacity-100 hover:visible transition duration"}>
